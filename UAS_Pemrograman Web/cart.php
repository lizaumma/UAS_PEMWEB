        ...
        <section class="shopping-cart">
         ...
         ?>
                    ...
                    <tr>
                        ...
                        <td><a href="cart.php?remove=<?php echo $fetch_cart['id']; ?>"
                                onclick="return confirm('Apkah ingin menghapus produk dari cart?')" class="delete-btn">
         ...
         ?>
                    <tr class="table-bottom">
                        <td><a href="products.php" class="option-btn" style="margin-top: 0;">Lanjut Beli</a></td>
                        <td colspan="3">Total Akhir</td>
                        <td>$<?php echo $grand_total; ?>/-</td>
                        <td><a href="cart.php?delete_all"
                                onclick="return confirm('Apakah anda yakin ingin menghapus semua?');"
                                class="delete-btn"> <i class="fas fa-trash"></i> Hapus Semua </a></td>
                    </tr>
